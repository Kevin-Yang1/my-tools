...
- `scripts/hust_autologin.py`: 启动 HUST 校园网自动登录工具，安装后命令名为 `hust-autologin`。实际源码来自 `tools/hust-autologin` submodule。
...
- `tools/hust-autologin/`: HUST 校园网自动登录工具，源码仓库为 `https://github.com/Kevin-Yang1/hust-autologin.git`，本仓库通过 submodule 记录当前使用的提交。

详细说明见：

- [docs/wait_and_run.md](docs/wait_and_run.md)
- [docs/exp-scheduler.md](docs/exp-scheduler.md)
- [docs/hust-autologin.md](docs/hust-autologin.md)
